...
require_once(dirname(__FILE__).'/../../../lib/parser/sfYahooGeocoderParserPhp.class.php');

$t = new lime_test(6, new lime_output_color());

$singleResult = file_get_contents(dirname(__FILE__).'/../../fixtures/sfYahooGeocoderResponsePhp.txt');
$collectionResult = file_get_contents(dirname(__FILE__).'/../../fixtures/sfYahooGeocoderResponseCollectionPhp.txt');

$t->diag('->parse() a single result');

$parser = new sfYahooGeocoderParserPhp();
